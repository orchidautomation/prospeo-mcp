...
// ==========================================================================
server.tool("prospeo_enrich_person", "Enrich a person to get their verified work email, title, LinkedIn, mobile, and employment history. Provide name + company, OR LinkedIn URL, OR email, OR person_id. Costs 1 credit.", {
    ...
    try {
        ...
        return {
            content: [{ type: "text", text: safeJson({ person: result.person, company: result.company }) }],
        };
    }
    catch (err) {
...
// ==========================================================================
server.tool("prospeo_bulk_enrich_person", "Enrich up to 50 people in one call. Each record needs name + company or LinkedIn URL. Returns matched/unmatched/invalid lists. Costs 1 credit per matched record.", {
    ...
    try {
        ...
        return {
            content: [{ type: "text", text: safeJson(result.response) }],
        };
    }
    catch (err) {
        const message = err instanceof Error ? err.message : "Unknown error";
...
// ==========================================================================
server.tool("prospeo_search_person", `Search 200M+ professional contacts. Returns 25 results per page. Costs 1 credit per page.
...
// ==========================================================================
server.tool("prospeo_enrich_company", "Enrich a company by domain or name. Returns industry, description, employee count, funding, technologies, revenue, and location. Costs 1 credit.", {
    ...
    try {
        ...
        return {
            content: [{ type: "text", text: safeJson(result.company) }],
        };
    }
    catch (err) {
        const message = err instanceof Error ? err.message : "Unknown error";
...
// ==========================================================================
server.tool("prospeo_search_company", `Search 30M+ companies by industry, size, location, funding round, and technology stack. Returns 25 results per page. Costs 1 credit per page.
...
// ==========================================================================
server.tool("prospeo_bulk_enrich_company", "Enrich up to 50 companies in one call. Returns industry, tech stack, funding, employee count for each. Costs 1 credit per matched record.", {
...
// ==========================================================================
server.tool("prospeo_account_info", "Check your Prospeo account: remaining credits, plan, usage, and next renewal date. Free — no credits consumed.", {}, async () => {
    try {
